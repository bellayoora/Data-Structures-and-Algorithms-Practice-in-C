...
void quicky(char* data, int left, int right) {
  ...
  quicky(data, left, i);      // sort the sub-array of elements with values less than the pivot
  quicky(data, i+2, right);  // sort the sub-array of elements with values greater than the pivot
